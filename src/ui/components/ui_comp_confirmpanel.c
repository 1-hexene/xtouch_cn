...
void ui_confirmPanel_show(const char *title, void (*onYES)(void))
{
    ...
    lv_obj_set_style_text_font(titleLabel, &CHINESE_UI_FONT, LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t *ui_confirmPanel_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_set_style_text_font(cui_confirmPanelNOLabel, &CHINESE_UI_FONT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_confirmPanelYESLabel, &CHINESE_UI_FONT, LV_PART_MAIN | LV_STATE_DEFAULT);
