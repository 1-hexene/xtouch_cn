...
lv_obj_t *ui_sidebarComponent_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_set_style_bg_color(cui_sidebarHomeButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(cui_sidebarHomeButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_opa(cui_sidebarHomeButton, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(cui_sidebarHomeButton, lv_color_hex(0xff4e55), LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_width(cui_sidebarHomeButtonIcon, lv_pct(120));  /// 100
    lv_obj_set_height(cui_sidebarHomeButtonIcon, lv_pct(29)); /// 24
    ...
    lv_obj_set_style_bg_color(cui_sidebarTempButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(cui_sidebarTempButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_opa(cui_sidebarTempButton, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(cui_sidebarTempButton, lv_color_hex(0xff4e55), LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_width(cui_sidebarTempButtonIcon, lv_pct(120));  /// 100
    lv_obj_set_height(cui_sidebarTempButtonIcon, lv_pct(29)); /// 24
    ...
    lv_obj_set_style_bg_color(cui_sidebarControlButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(cui_sidebarControlButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_opa(cui_sidebarControlButton, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(cui_sidebarControlButton, lv_color_hex(0xff4e55), LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_width(cui_sidebarControlButtonIcon, lv_pct(120));  /// 100
    lv_obj_set_height(cui_sidebarControlButtonIcon, lv_pct(29)); /// 24
    ...
    lv_obj_set_style_bg_color(cui_sidebarNozzleButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(cui_sidebarNozzleButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_opa(cui_sidebarNozzleButton, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(cui_sidebarNozzleButton, lv_color_hex(0xff4e55), LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_style_bg_color(cui_sidebarSettingsButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(cui_sidebarSettingsButton, lv_color_hex(0xff9a9e), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_opa(cui_sidebarSettingsButton, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(cui_sidebarSettingsButton, lv_color_hex(0xff4e55), LV_PART_MAIN | LV_STATE_PRESSED);
    ...
    lv_obj_set_width(cui_sidebarSettingsButtonIcon, lv_pct(120));  /// 100
    lv_obj_set_height(cui_sidebarSettingsButtonIcon, lv_pct(29)); /// 24
