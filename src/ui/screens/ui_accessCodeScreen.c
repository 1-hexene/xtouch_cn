...
void ui_accessCodeScreen_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_accessCodeInput, &ui_font_pingfang_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_accessCodeInput, &ui_font_pingfang_22, LV_PART_TEXTAREA_PLACEHOLDER | LV_STATE_DEFAULT);
