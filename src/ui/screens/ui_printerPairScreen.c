...
void ui_printerPairScreen_screen_init(void)
{
    ...
    lv_roller_set_options(ui_printerPairScreenRoller, " 正在搜索无线局域网...", LV_ROLLER_MODE_NORMAL);
    ...
    lv_obj_set_x(ui_printerPairScreenSubmitButton, -100);
    lv_obj_set_y(ui_printerPairScreenSubmitButton, -100);
